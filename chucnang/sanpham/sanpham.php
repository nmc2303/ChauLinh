...
<div class="products">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            ...
            <strike><p class="price">Giá: <?php echo number_format($row['gia_sp']) ; ?> VNĐ</p></strike>
            <p>SALE: <?php echo $row['sale']; ?> %</p> 
            <p class="price"> Giá giảm:<?php if($row['sale']!=null) echo number_format($row['gia_sp']*(100-$row['sale'])/100) ; else echo number_format($row['gia_sp'])  ; ?> VNĐ</p>
        </div>
        <?php
            }
...
<div class="products">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            ...
            <p>Số lượng: <?php echo $row2['bao_hanh']; ?></p>
            <p>Tình trạng: <?php echo $row2['tinh_trang']; ?></p>
            <p class="price">Giá: <?php echo number_format($row2['gia_sp']) ; ?>VNĐ</p>
        </div>
        <?php  
            }
        ?>
