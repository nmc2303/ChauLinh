...
<?php
	...
	$sql="SELECT * FROM user ORDER BY user_id ASC LIMIT $perPage,$rowPerPage";
                ...
                <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-sort-name="name" data-sort-order="desc">
                    ...
                    <tbody>
                        ...
                        <tr style="height: 300px;">
                            ...
                            <td data-checkbox="true"><?php echo $row['user_address']; ?></td>
                            <td data-checkbox="true"><?php echo $row['user_number']; ?></td>
                            <td data-checkbox="true"><?php echo $row['user_email']; ?></td>
