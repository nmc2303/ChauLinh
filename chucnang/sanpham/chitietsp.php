...
<div id="product">
    ...
    <div id="prd-intro" class="col-md-6 col-sm-12 col-xs-12">
        ...
        <p id="prd-price"><span class="sl">Giá sản phẩm giảm:</span> <span class="sr"><?php if($row['sale']!=null) echo number_format( $row['gia_sp']*(100-$row['sale'])/100,0,".",",") , "VNĐ","  ", "<strike>" ,number_format($row['gia_sp']) ,"VNĐ", "</strike>" ;else echo number_format($row['gia_sp'],0,".",",") ; ?> </span></p>
        <p><span class="sl">Đi kèm:</span><?php echo $row['phu_kien']; ?></p>
        <p><span class="sl">Sale :</span><?php echo $row['sale']; ?> %</p>
