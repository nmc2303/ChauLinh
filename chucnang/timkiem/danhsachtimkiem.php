<?php  
    ...
    $sql= "SELECT * FROM product WHERE product_name LIKE ('$stextNew') ORDER BY product_id DESC LIMIT $perRow,$rowPerPage";
    $query= mysqli_query($conn, $sql);

    $totalRow=mysqli_num_rows(mysqli_query($conn, "SELECT * FROM product WHERE product_name LIKE ('$stextNew')"));
...
<div class="products">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            <a href="index.php?page_layout=chitietsp&product_id=<?php echo $row['product_id']; ?>"><img width="80" height="144" src="quantri/anh/<?php echo $row['product_image']; ?>"></a>
            <h3><a href="index.php?page_layout=chitietsp&product_id=<?php echo $row['product_id']; ?>"><?php echo $row['product_name']; ?></a></h3>
